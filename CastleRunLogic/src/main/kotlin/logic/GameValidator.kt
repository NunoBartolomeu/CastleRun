...
class GameValidator(val game: Game) {
    ...
    private fun hasPieceToDeploy(player: Player) {
    ...
    fun isValidDamage(player: Player, piece: Piece) {
        isGameOver()
    ...
    fun isValidDeploy(player: Player, entry: Position) {
        isGameOver()
